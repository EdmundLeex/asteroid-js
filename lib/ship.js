(function() {
  ...
  Ship.TOP_SPEED = 10;
  Ship.ACCELERATOR = 1;
  Ship.ROTATE_ANGLE = (3 * Math.PI) / 180; // 3 degree
  Ship.WIDTH = 15;
  Ship.HEIGHT = 25;
  ...
  Ship.prototype.brake = function () {
    ...
    if (this.speed() > 0) {
      ...
      // this.vel[0] -= Math.sin(this.theta) * (Math.pow(Ship.ACCELERATOR, 2));
      // this.vel[1] -= -Math.cos(this.theta) * (Math.pow(Ship.ACCELERATOR, 2));
    }
