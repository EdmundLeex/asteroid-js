(function(root){
	// all moving objs mixin pooling
	// pooling provides functions and data structure
	// each obj is a node
	if (typeof root.Asteroids === 'undefined') {
    root.Asteroids = {};
  }

  var LinkedListNode = Asteroids.LinkedListNode = function (obj) {
  	this.obj = obj;
  	this.nextNode = null;
  	this.prevNode = null;
  	this.list = null;
  ...
  // LinkedListNode.prototype.object = function () {
  // 	return this.obj;
  // };
  ...
  // LinkedList.prototype.addNewNode = function (obj) {
