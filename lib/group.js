(function(root){
  ...
  var _randomPos = function (game, maxSize) {
  	var randPos;
		...
		switch(randIdx){
			case 0:
				randPos = [randX, Asteroids.Asteroid.RADIUS];
				break;
			case 1:
				randPos = [randX, game.height - Asteroids.Asteroid.RADIUS];
				break;
			case 2:
				randPos = [Asteroids.Asteroid.RADIUS, randY];
				break;
			case 3:
				randPos = [game.width - Asteroids.Asteroid.RADIUS, randY];
				break;
			default:
				// no op
				break;
	...
	root.Asteroids.FormGroup = function (form) {
		...
		var _vel = function (pos, game) {
			...
			var groupVel = Math.random() * 1 + 0.3
