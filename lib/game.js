(function(root) {
  ...
  Game.prototype.allObjects = function() {
    return this.asteroidsInUse.concat(this.ship, this.bulletsInUse, this.boidsInUse);
  };
  ...
  Game.prototype.checkCollisions = function() {
    ...
    for (var l = 0; l < this.boidsInUse.length; l++) {
      if (this.ship.isCollidedWith(this.boidsInUse[l])) {
        var boid = this.boidsInUse.splice(l, 1)[0];
    ...
    for (var k = 0; k < this.bulletsInUse.length; k++) {
      for (var j = 0; j < this.asteroidsInUse.length; j++) {
        if (this.bulletsInUse[k].isCollidedWith(this.asteroidsInUse[j])) {
          ...
          var bul = this.bulletsInUse.splice(k, 1)[0];
    ...
    for (var n = 0; n < this.bulletsInUse.length; n++) {
      for (var m = 0; m < this.boidsInUse.length; m++) {
        if (this.bulletsInUse[n].isCollidedWith(this.boidsInUse[m])) {
          var boid = this.boidsInUse.splice(m, 1)[0];
          this.boids.unshift(boid);

          var bul = this.bulletsInUse.splice(n, 1)[0];
          this.bullets.unshift(bul);
