(function() {
  ...
  GameView.prototype.bindKeyHandlers = function() {
    ...
    window.addEventListener('keydown', function (e) {
      ...
      switch(e.keyCode){
        ...
        case 32:
          // space
          this.spaceInterval = window.setInterval(ship.fireBullet.bind(ship), 2000);
          break;
        default:
          break;
      }
    ...
    // this.intervals["up"] = window.setInterval(func, 1000)

    // window.clearInterval(this.intervals["up"])
    ...
    // if (window.key.isPressed('P')) { console.log('preseed') };
  };
  ...
  GameView.prototype.setPowerTimer = function () {
    ...
    if (!gameView.intervals.up) {
      gameView.intervals.up = window.setInterval(ship.power.bind(ship), 1000 / GameView.FPS);
    }
  }
