(function(root) {
  ...
  Asteroids.Util.randomPos = function (game, maxSize) {
  ...
  Asteroids.Util.ensureDistanceFromShip = function (game) {
    var pos = Asteroids.Util.randomPos(game, 0);
    while (Asteroids.Util.calcDist(pos, game.ship.pos) < 50) {
      pos = Asteroids.Util.randomPos(game, 0);
    }
    return pos;
  }
})(this);
